...
2. Run python3 PLOT_RABI.py <distance> <num_bins> <cutoff>  where num_bins is the number of subdivisions of theta you want and 'cutoff' is the minimum number of data points you need in a given bin for it to be plotted.
