...
# file_list = glob.glob("Results_of_RUN_RABI/processed/d3/p=0.0030_d3_reuse_unrot_theta-1.300π_phi0.000π_sweeps3_reps_2828427_id14994747737283795488.dat") # will plot graphs for all files in this directory (need to add a way to combine files)

dist = sys.argv[1]


# New: try group by theta bins:
try_group_by_bins = True
